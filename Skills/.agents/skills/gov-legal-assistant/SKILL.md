...
## Перетворення ДП, Корпоративне право та Управління держвласністю

Цей розділ охоплює ключову нормативно-правову базу, яка застосовується при правовому супроводі реорганізації державних підприємств (ДП) галузі, корпоративних відносин та управління об'єктами державної власності.

### 1. Перетворення державних підприємств (Корпоратизація / Приватизація)

#### 1.1. Корпоратизація ДП
- **Закон України «Про управління об'єктами державної власності»** (21.09.2006 № 185-V) — базовий закон, що регулює повноваження органів управління держвласністю (в т.ч. ДКА) та порядок перетворення ДП на господарські товариства.
- **Указ Президента України «Про корпоратизацію підприємств»** від 15.06.1993 № 210/93 — первинний акт про перетворення ДП на відкриті акціонерні товариства зі 100% держчасткою. Застосовується з урахуванням змін, внесених наступним законодавством.
- **Постанова КМУ від 05.07.1993 № 508 «Про порядок корпоратизації підприємств»** — регулює процедуру та строки корпоратизації, зміст плану перетворення, порядок затвердження статуту товариства.

#### 1.2. Приватизація
- **Закон України «Про приватизацію державного та комунального майна»** (18.01.2018 № 2269-VIII) — основний акт щодо відчуження держвласності шляхом продажу; встановлює перелік об'єктів, що не підлягають приватизації (в т.ч. стратегічні підприємства оборонно-промислового та космічного комплексу).
- Перевіряти: чи включено конкретне ДП до переліку об'єктів, що заборонено приватизувати (Додаток до Закону № 2269-VIII або окремі рішення ВРУ/КМУ).

#### 1.3. Реорганізація ДП загального характеру
- **Господарський кодекс України** (16.01.2003 № 436-IV), Глави 7–8 — загальні положення про реорганізацію (злиття, приєднання, поділ, виділ, перетворення) підприємств; правонаступництво при реорганізації.
- **Цивільний кодекс України** (16.01.2003 № 435-IV), Глава 7 — загальні норми про юридичних осіб (ст. 104–112 ЦКУ щодо припинення та реорганізації ЮО).
- **Закон України «Про державну реєстрацію юридичних осіб, фізичних осіб – підприємців та громадських формувань»** (15.05.2003 № 755-IV) — порядок державної реєстрації змін при реорганізації, реєстрація правонаступника, внесення записів до ЄДР.

---

### 2. Акціонерні товариства (АТ)

- **Закон України «Про акціонерні товариства»** (17.09.2008 № 514-VI, зі змінами) — основний закон, що регулює:
  - Порядок створення АТ (в т.ч. шляхом перетворення ДП — ст. 9, 10, 18).
  - Структуру корпоративного управління: загальні збори акціонерів, наглядова рада, виконавчий орган, ревізійна комісія / аудитор (ст. 32–73).
  - Права акціонерів, в т.ч. держави як єдиного акціонера (ст. 25–30).
  - Порядок збільшення/зменшення статутного капіталу (ст. 15–16).
  - Порядок виплати дивідендів (ст. 30).
  - Велика угода та угода з пов'язаними особами (ст. 70–74).
- **Порядок погодження значних правочинів та правочинів з конфліктом інтересів**: при наявності наглядової ради держпідприємства як АТ з 100% держчасткою — перевіряти, чи відповідає правочин вимогам Закону «Про АТ» та Закону «Про управління об'єктами державної власності».
- **Практична увага для ДКА**: ДКА як орган управління часткою держави в АТ здійснює права акціонера відповідно до ст. 6–8 Закону «Про управління об'єктами державної власності». Представник держави на загальних зборах АТ діє на підставі довіреності ДКА.

---

### 3. Товариства з обмеженою відповідальністю (ТОВ)

- **Закон України «Про товариства з обмеженою та додатковою відповідальністю»** (06.02.2018 № 2275-VIII) — регулює:
  - Порядок створення та реєстрації ТОВ (ст. 11–14).
  - Права та обов'язки учасників ТОВ (ст. 10–20), в т.ч. держави як учасника.
  - Структуру управління: загальні збори учасників, виконавчий орган (директор / дирекція), наглядова рада (якщо передбачена статутом) (ст. 29–54).
  - Вихід учасника з ТОВ та успадкування частки (ст. 21–26).
  - Реорганізацію та ліквідацію ТОВ (ст. 57–67).
- **Практична увага для ДКА**: Якщо ДКА бере участь у ТОВ (спільне підприємство або ТОВ з держчасткою), застосовуються також положення Закону «Про управління об'єктами державної власності». Переконайтесь, що статут ТОВ не суперечить цьому Закону, а рішення, що стосуються розпорядження держчасткою, отримали відповідні погодження.

---

### 4. Управління об'єктами державної власності

- **Закон України «Про управління об'єктами державної власності»** (21.09.2006 № 185-V) — центральний акт, що встановлює:
  - Об'єкти управління: ДП, пакети акцій (частки) в господарських товариствах, майнові комплекси (ст. 3–5).
  - Повноваження суб'єктів управління (КМУ, ФДМУ, галузеві міністерства та агентства, зокрема ДКА) (ст. 6–8).
  - Порядок призначення та відкликання керівників ДП, укладення та розірвання з ними контрактів (ст. 16–18).
  - Передача об'єктів між суб'єктами управління (ст. 9).
  - Контроль за ефективністю управління: фінансові плани ДП, звіти керівників (ст. 19–20).
- **Постанова КМУ від 19.06.2007 № 831 «Про затвердження Порядку складання, затвердження та контролю виконання фінансових планів державних підприємств»** — обов'язкові фінплани ДП, що перебувають у сфері управління ДКА; юридична служба перевіряє відповідність проектів фінпланів чинному законодавству.
- **Постанова КМУ від 02.08.2005 № 676 «Про Типовий статут державного підприємства»** (зі змінами) — орієнтир при розробці/перегляді статутів ДП галузі.
- **Постанова КМУ від 09.03.2006 № 246 «Про затвердження Порядку призначення і звільнення керівників державних підприємств»** — порядок проведення конкурсу та укладення контракту з керівником ДП; перевіряти відповідність контрактів типовій формі.
- **Наказ ФДМУ від 23.09.1996 № 1012/1018 «Про затвердження Типового договору (контракту) з керівником підприємства, що є у державній власності»** — типова форма контракту з керівником держпідприємства.
- **Закон України «Про Фонд державного майна України»** (09.12.2011 № 4107-VI) — повноваження ФДМУ щодо об'єктів, переданих до сфери його управління або приватизаційних процедур, що перетинаються з повноваженнями ДКА.

---

### 5. Чеклист юридичного супроводу перетворення ДП (Practical Checklist)

При отриманні завдання щодо правового супроводу перетворення ДП, що входить до сфери управління ДКА:

1. **Перевірити підстави**: Наявність рішення КМУ або ДКА (як органу управління) про ініціювання корпоратизації/реорганізації.
2. **Перевірити можливість приватизації**: Чи не включено ДП до переліку об'єктів, що не підлягають приватизації (Додаток до ЗУ № 2269-VIII, Постанова КМУ про об'єкти, що не приватизуються).
3. **Визначити форму перетворення**: ДП → АТ (100% держчастка) / ДП → ТОВ / ДП → казенне підприємство (якщо потрібний особливий статус).
4. **Розробити план перетворення**: Відповідно до ПКМ № 508 (для корпоратизації) — склад комісії, строки, перелік активів, проект статуту.
5. **Погодження**: Отримати погодження КМУ / ФДМУ залежно від форми перетворення та вартості активів.
6. **Реєстраційні дії**: Підготувати пакет документів для внесення змін до ЄДР (передавальний акт / розподільчий баланс, новий статут, рішення про перетворення, відомості про правонаступника).
7. **Повідомлення кредиторів**: Відповідно до ч. 1 ст. 105 ЦКУ — не пізніше 2 місяців з дати рішення про реорганізацію.
8. **Трудові відносини**: Забезпечити дотримання вимог КЗпП (попередження працівників про зміну умов праці, переукладення колективного договору з правонаступником).
9. **Захист інтелектуальної власності**: Перевірити передачу прав на результати науково-технічної діяльності (космічні розробки, патенти, ліцензії) правонаступнику.
10. **Перевірка відповідності нормам про держтаємницю**: Якщо ДП має режимно-секретний підрозділ або допуски до ДТ — погодити з СБУ та ДСС питання збереження режиму після перетворення.
